...
pub use canopus_target_generated::{
    canopus_identity_guard, canopus_thumb_callable, CANOPUS_FW_APP_INSTALL_CALLABLE,
    CANOPUS_FW_CONTROLLER_CRASH_DUMP_CALLABLE, CANOPUS_FW_HIDDEN_AND_SHOW_APP_CB_CALLABLE,
    CANOPUS_FW_IOCTL_CALLABLE, CANOPUS_FW_LV_IMAGE_SET_SRC_CALLABLE,
    CANOPUS_FW_PROTOBUF_SET_ORDERED_APP_LIST_CALLABLE, CANOPUS_FW_RENAME_CALLABLE,
    CANOPUS_FW_SEM_POST_CALLABLE, CANOPUS_FW_SEM_TRYWAIT_CALLABLE, CANOPUS_FW_SEM_WAIT_CALLABLE,
    CANOPUS_FW_SERVICE_MANAGER_GET_PROFILE_CALLABLE, CANOPUS_FW_SERVICE_MANAGER_REGISTER_CALLABLE,
