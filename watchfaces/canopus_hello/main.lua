-- One-shot Canopus module installer watchface.
...
local title = lvgl.Label(root, {
    text = "Canopus Module", text_color = 0xFFFFFF,
...
local function stage_files()
    ...
    if type(module) ~= "string" or #module < 512 or #module > 131072
